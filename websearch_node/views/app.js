...
app.get('/', (req, res) => {
    console.log("timestamp-test", req.timestamp);
    ...
    axios.get('https://api.rainforestapi.com/request', {
        ...
        .then(response => {
            ...
            */
            ...
            /* const destFilename = "compare_phones.json";
            const srcFilename = "/my_phone_tables/phone_prices.json";
            ...
            console.log("destFIle", destFilename);  */

            // get the timestamp from the file 

            // do I need to download the file from cloud storage and compare the timestamp with my new request ? OR can I do it in GCP ?
            ...
            async function storeFile() {
                try {
                    ...
                    */
                    ...
                    storage
                        .bucket(bucketName)
                        .upload("phone_prices.json", {
                            destination: '/my_phone_tables/phone_prices.json'
                        })
                        .then(() => {
                            console.log('success');
                        })
